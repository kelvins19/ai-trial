...
#     prompt = """Return the PDA Chromatogram  of Sample (A, Main Drug Concentration 0.8 mg/mL) 
# and SIM Chromatogram of Mixed Standard Solution graph"""
    prompt = """Return repeatability  for  the  mix  standard  solution 
which concentration of 10, 50 and 500 μg/L table"""
